...
public class SA_TBucket extends TBucket{
	...
	public SA_TBucket(int nodeId, GraphGenerator2 generator)
	{
		minNodeId = nodeId;
		maxNodeId = nodeId;
		maxDeg = 0;
	...
	public int[] selectNodeInTBucket()
	{
		...
		while(true)
		{
			...
			if(generator.random.nextDouble() < Math.pow(generator.deg[selectedNode], generator.dExp) / Math.pow(maxDeg, generator.dExp))
			{
