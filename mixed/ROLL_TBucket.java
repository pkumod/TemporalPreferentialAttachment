...
public class ROLL_TBucket extends TBucket{
	...
	public ROLL_TBucket(GraphGenerator generator)
	{
		// this method should never been invoked
		System.err.println("ROLL_TBucket(GraphGenerator generator): this method should never been invoked");
	...
	public ROLL_TBucket(HashMap<Integer, IntArrayList> bucketMap, GraphGenerator generator)
	{
		root = new TreeNode(true);
		this.generator = generator;
		...
		while(degItor.hasNext())
		{
			...
			tBucketWeight += degree * degBucket.size();
			size += degBucket.size();
		}
	...
	public void mergeTBuckets(TBucket anotherTBucket)
	{
		...
		while(anotherItor.hasNext())
		{
			...
			Bucket degBucket = another_ROLL_TBucket.buckets.get(degree); // modified 2020-11-22
